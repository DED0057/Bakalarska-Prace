...
*/
/*
License: Commercial, https://www.ajax-zoom.com/index.php?cid=download
*/
if ( !defined( 'ABSPATH' ) ) {
	exit;
}

if ( !empty( preg_grep( '/\/woocommerce.php/', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) ) {
